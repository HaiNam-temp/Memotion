...
def upgrade():
    ...
    # Add new columns for 1-1 relationships
    op.add_column('patient_profile', sa.Column('physical_therapy_id', postgresql.UUID(as_uuid=True), nullable=True), schema='memotion')
    op.add_column('patient_profile', sa.Column('mental_decline_id', postgresql.UUID(as_uuid=True), nullable=True), schema='memotion')
    op.add_column('patient_profile', sa.Column('loneliness_id', postgresql.UUID(as_uuid=True), nullable=True), schema='memotion')
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    # Remove new columns for 1-1 relationships
    op.drop_column('patient_profile', 'loneliness_id', schema='memotion')
    op.drop_column('patient_profile', 'mental_decline_id', schema='memotion')
    op.drop_column('patient_profile', 'physical_therapy_id', schema='memotion')
