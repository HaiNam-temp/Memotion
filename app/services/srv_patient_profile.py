...
class PatientProfileService:
    def __init__(self, profile_repo: PatientProfileRepository = Depends()):
        self.profile_repo = profile_repo

    def create_patient_profile(self, data: PatientProfileCreateRequest, current_user: User):
        # Check if profile already exists
        if self.profile_repo.get_profile_by_patient_id(current_user.user_id):
    ...
    def create_physical_therapy_profile(self, data: PhysicalTherapyCreateRequest, current_user: User):
        ...
        if self.profile_repo.get_physical_therapy_by_profile_id(profile.profile_id):
        ...
        return self.profile_repo.create_physical_therapy(new_therapy)
