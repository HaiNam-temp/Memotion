...
class PatientProfile(Base):
    ...
    bmi_score = Column("BMI_score", Integer)
    map_score = Column("MAP_score", Integer)
    rhr_score = Column("RHR_score", Integer)
    adl_score = Column("ADL_score", Integer)
    iadl_score = Column("IADL_score", Integer)
